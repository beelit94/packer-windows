...
start /wait wusa C:\Windows\Temp\Windows6.1-KB2506143-x64.msu /quiet /norestart
GOTO :DONE
...
start /wait wusa C:\Windows\Temp\Windows6.1-KB2506143-x86.msu /quiet /norestart
GOTO :DONE
